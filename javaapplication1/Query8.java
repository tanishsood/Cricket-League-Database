...
public class Query8 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("       Players Who played most Number Of Matches In descending Order");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         try {
            String query = "select PlayerName from PlayerInfo natural join TeamInfo where id in(select id from player natural join match group by MatchID order by count(MatchID) DESC)";
...
//Print one row          
            ...
            PrintWriter pw = new PrintWriter("PlayerMostMatches.csv");
            pw.write(result);
            pw.close();
        }
        catch(IOException e){}
